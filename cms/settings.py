...
SECRET_KEY = 'django-insecure-zfsi0^#u(11$wf1dofiwn1z&*ggk6c$t2i0^85@=pqe2uwn9sp'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dashboard', 'static'),  # This is correct for static files
]

# STATIC_ROOT for collectstatic when deploying
...
INSTALLED_APPS = [
    ...
    'staff',
    'dashboard',
    'django_extensions',  # For additional features like model validation
]
